...
For example, if you wanted to add a new test *factor* for the next Ceph release of luminous this is how you'd accomplish that. Currently, the first factor set in our ``envlist``
